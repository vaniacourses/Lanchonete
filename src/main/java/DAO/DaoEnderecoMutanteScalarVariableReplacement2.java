 ...
 * @author kener_000
 */
public class DaoEnderecoMutanteScalarVariableReplacement2 {
    private Connection conecta;

    public DaoEnderecoMutanteScalarVariableReplacement2() {
    ...
    public void salvar(Endereco endereco){
        ...
        try{
            ...
            /**
            *
            * Aqui Complemento é repetido, no lugar de cidade e estado que também é uma string.
            */
    ...
    public int validaEndereco(Endereco endereco){
        ...
        try(PreparedStatement stmt = conecta.prepareStatement(sql);){
            ...
            /**
            *
            * Aqui Bairro é repetido, no lugar de cidade estado, que também são uma string.
            */
    ...
    public Endereco pesquisarEnderecoPorObjeto(Endereco endereco){
        ...
        try(PreparedStatement stmt = conecta.prepareStatement(sql);){
            ...
            while(rs.next()){
                ...
                /**
                *
                * Aqui número é repetido, no lugar de cidade id-endereço, que também é uma string.
                */
                resultado.setNumero(rs.getInt("numero"));
            }
            rs.close();

 ...
 * @author kener_000
 */
public class DaoEnderecoMutanteConditionalOperatorReplacement1 {
    private Connection conecta;

    public DaoEnderecoMutanteConditionalOperatorReplacement1() {
    ...
    public int validaEndereco(Endereco endereco){
        ...
        try(PreparedStatement stmt = conecta.prepareStatement(sql);){
            ...
            /**
            *
            * Mutante onde if inicia quando a condição não é cumprida.
            */
            if(!rs.next()){

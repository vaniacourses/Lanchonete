 ...
 * @author kener_000
 */
public class DaoIngredienteMutanteScalarVariableReplacement2 {
    private Connection conecta;

    public DaoIngredienteMutanteScalarVariableReplacement2() {
    ...
    public void salvar(Ingrediente ingrediente){
        ...
        try{
            ...
            /**
            *
            * Aqui valor_compra é repetido no lugar de valor_venda, que também é uma double.
            */
            ...
            stmt.setDouble(5, ingrediente.getValor_compra());
        ...
        try{
            ...
            while (rs.next()){
                ...
                */
                ...
                ingrediente.setValor_compra(rs.getDouble("valor_venda"));
        ...
        try{
            ...
            while (rs.next()){
                ...
                */
                ...
                ingredienteResultado.setValor_compra(rs.getDouble("valor_venda"));

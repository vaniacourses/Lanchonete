 ...
 * @author kener_000
 */
public class DaoBebidaMutanteScalarVariableReplacement2 {
    private Connection conecta;

    public DaoBebidaMutanteScalarVariableReplacement2() {
    ...
    public void salvar(Bebida bebida){
        ...
        try{
            ...
            stmt.setString(2, bebida.getNome());
            /**
            *
            * Mutante onde nome é repetido, no lugar de descrição.
            */

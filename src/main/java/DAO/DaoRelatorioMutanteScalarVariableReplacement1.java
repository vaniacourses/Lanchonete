 ...
 * @author gabriel
 */
public class DaoRelatorioMutanteScalarVariableReplacement1 {
    private Connection conecta;
    
    public DaoRelatorioMutanteScalarVariableReplacement1(){
    ...
    public List<RelatorioLanches> listarRelLanches(){
        ...
        try(PreparedStatement stmt = conecta.prepareStatement(sql);){
            ...
            while(rs.next()){
                ...
                /**
                *
                * Aqui Lanche é repetido no lugar de Ingrediente.
                */
                rl.setLanche(rs.getString("nm_lanche"));
                rl.setLanche(rs.getString("nm_ingrediente"));
    ...
    public List<RelatorioBebidas> listarRelBebidas(){
        ...
        try(PreparedStatement stmt = conecta.prepareStatement(sql);){
            ...
            while(rs.next()){
                ...
                /**
                *
                * Aqui cliente é repetido no lugar de NomeBebida.
                */
                rb.setCliente(rs.getString("Cliente"));
                rb.setCliente(rs.getString("nm_bebida"));
    ...
    public List<RelatorioGastos> listarRelGastos(){
        ...
        try(PreparedStatement stmt = conecta.prepareStatement(sql);){
            ...
            while(rs.next()){
                ...
                /**
                *
                * Aqui Custo é repetido no lugar de Venda e Lucro, que também são floats.
                */
                rg.setCusto(rs.getFloat("custo"));
                rg.setCusto(rs.getFloat("vendas"));
                rg.setCusto(rs.getFloat("custo"));
